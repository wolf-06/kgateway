...
This file is a fork of sigs.k8s.io/gwctl/cmd/analyze/analyze.go
It is modified to use use kgateway resource relations in the topology graph and our custom extensions.
The command is renamed to analyze to make it clear that it is used for validating changes before they are applied.
*/
package analyze
...
func NewCmd(factory common.Factory, iostreams genericiooptions.IOStreams, cliConfig *config.CliConfig) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Anaylze resources by file names or stdin",
...
func (f *analyzeFlags) ToOptions(_ []string, factory common.Factory, iostreams genericiooptions.IOStreams, cliConfig *config.CliConfig) (*analyzeOptions, error) {
...
func (o *analyzeOptions) Run() error {
	...
	// Step 7: Collect errors from the graph. These are the collective set of
